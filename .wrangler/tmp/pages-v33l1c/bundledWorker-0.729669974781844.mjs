...
// ../.wrangler/tmp/bundle-hXsLQr/checked-fetch.js
...
var d = /* @__PURE__ */ __name((e, t, r) => (_e(e, t, "read from private field"), r ? r.call(e) : t.get(e)), "d");
...
var Fe = /* @__PURE__ */ __name((e, t, r, a) => ({ set _(o) {
  m(e, t, o, r);
}, get _() {
  return d(e, t, a);
} }), "Fe");
var Ue = /* @__PURE__ */ __name((e, t, r) => (a, o) => {
  let n = -1;
  return s(0);
  async function s(i) {
...
var $e = /* @__PURE__ */ __name((e) => /[%+]/.test(e) ? (e.indexOf("+") !== -1 && (e = e.replace(/\+/g, " ")), e.indexOf("%") !== -1 ? Ke(e, it) : e) : e, "$e");
...
var Bt = st;
var _t = /* @__PURE__ */ __name((e, t) => st(e, t, true), "_t");
var it = decodeURIComponent;
var We = /* @__PURE__ */ __name((e) => Ke(e, it), "We");
var de;
var L;
var H;
var dt;
...
var lt = (Xe = class {
...
}, de = /* @__PURE__ */ new WeakMap(), L = /* @__PURE__ */ new WeakMap(), H = /* @__PURE__ */ new WeakSet(), dt = /* @__PURE__ */ __name(function(e) {
  const t = d(this, L)[0][this.routeIndex][1][e], r = b(this, H, He).call(this, t);
  return r && /\%/.test(r) ? We(r) : r;
}, "dt"), ct = /* @__PURE__ */ __name(function() {
  ...
  return e;
}, "ct"), He = /* @__PURE__ */ __name(function(e) {
  return d(this, L)[1] ? d(this, L)[1][e] : e;
}, "He"), V = /* @__PURE__ */ new WeakMap(), Xe);
var $t = { Stringify: 1 };
var pt = /* @__PURE__ */ __name(async (e, t, r, a, o) => {
...
var Ht = (Qe = class {
  ...
  constructor(e, t) {
    ...
    h(this, "html", (e2, t2, r) => {
      const a = /* @__PURE__ */ __name((o) => b(this, D, ie).call(this, o, t2, qe("text/html; charset=UTF-8", r)), "a");
...
var Ft = (me = class {
  ...
  route(t, r) {
    ...
    return r.routes.map((o) => {
      var s;
      let n;
      r.errorHandler === Ge ? n = o.handler : (n = /* @__PURE__ */ __name(async (i, l) => (await Ue([], r.errorHandler)(i, () => o.handler(i, l))).res, "n"), n[Dt] = o.handler), b(s = a, k, G).call(s, o.method, o.path, n);
    }), this;
  }
  basePath(t) {
  ...
  mount(t, r, a) {
    let o, n;
    a && (typeof a == "function" ? n = a : (n = a.optionHandler, a.replaceRequest === false ? o = /* @__PURE__ */ __name((l) => l, "o") : o = a.replaceRequest));
    const s = n ? (l) => {
      const c = n(l);
...
}, P = /* @__PURE__ */ new WeakMap(), k = /* @__PURE__ */ new WeakSet(), ft = /* @__PURE__ */ __name(function() {
...
}, "ft"), A = /* @__PURE__ */ new WeakMap(), G = /* @__PURE__ */ __name(function(t, r, a) {
  ...
  throw t;
}, "Le"), Ne = /* @__PURE__ */ __name(function(t, r, a, o) {
...
var ht = [];
function Ut(e, t) {
  const r = this.buildAllMatchers(), a = /* @__PURE__ */ __name(((o, n) => {
...
}, J = /* @__PURE__ */ new WeakMap(), F = /* @__PURE__ */ new WeakMap(), Ce = /* @__PURE__ */ new WeakSet(), bt = /* @__PURE__ */ __name(function(e) {
  const t = [];
  let r = e === S;
...
}, W = /* @__PURE__ */ new WeakMap(), T = /* @__PURE__ */ new WeakMap(), ee = /* @__PURE__ */ new WeakMap(), fe = /* @__PURE__ */ new WeakMap(), O = /* @__PURE__ */ new WeakMap(), q = /* @__PURE__ */ new WeakSet(), Y = /* @__PURE__ */ __name(function(t, r, a, o, n) {
...
// ../.wrangler/tmp/bundle-hXsLQr/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-hXsLQr/middleware-loader.entry.ts
...
//# sourceMappingURL=bundledWorker-0.729669974781844.mjs.map
